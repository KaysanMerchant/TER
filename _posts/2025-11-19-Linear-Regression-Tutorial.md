...
I fixed a few things. The first thing I fixed was an outdated library used in the '.ipynb' fie. The library he was using(listed in the 'requirements.txt' file) was 'sklearn', which was deprecated. I changed it to 'scikit-learn' which is the updated version.
